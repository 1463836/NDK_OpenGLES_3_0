...
void TextureBufferSample::Draw(int screenW, int screenH) {
    ...
    LOGCATE("TextureBufferSample:: MaxVertexUniform=%d, MaxFragUniform=%d, maxVarying=%d, maxVextexAttri=%d",
            maxVertexUniform, maxFragmentUniform, maxVarying, maxVextexAttri);
 ...
 * */
void
TextureBufferSample::UpdateMVPMatrix(glm::mat4 &mvpMatrix, int angleX, int angleY, float ratio) {
