...
void MyGLRenderContext::SetParamsInt(int paramType, int value0, int value1) {
    loge("MyGLRenderContext::SetParamsInt paramType = %d, value0 = %d, value1 = %d", paramType,
         value0, value1);
...
//    loge("MyGLRenderContext::SetImageData format=%d, width=%d, height=%d, pData=%p", format,
//            width, height, pData);
    NativeImage nativeImage;
    nativeImage.format = format;
    nativeImage.width = width;
